...
if __name__ == '__main__':
    ...
    exam_test(modelMethodName="Resnet", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_noise"))
    exam_test(modelMethodName="Resnet", imgFolder=args.img_folder)
    exam_test(modelMethodName="Resnet", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_all"))
    recode_progressNum(2)
    exam_test(modelMethodName="CNN", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_noise"))
    exam_test(modelMethodName="CNN", imgFolder=args.img_folder)
    exam_test(modelMethodName="CNN", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_all"))
    recode_progressNum(3)
    exam_test(modelMethodName="Unet", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_noise"))
    exam_test(modelMethodName="Unet", imgFolder=args.img_folder)
    exam_test(modelMethodName="Unet", imgFolder=os.path.join(os.path.dirname(args.img_folder), "projections_all"))
