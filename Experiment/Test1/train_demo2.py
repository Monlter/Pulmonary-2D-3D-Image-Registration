...
if __name__ == '__main__':
    ...
    train(dataMethodName="origin")
    recode_progressNum(2)
    train(dataMethodName="origin_sub")
    recode_progressNum(3)
    train(dataMethodName="origin_edge")
    recode_progressNum(4)
    train(dataMethodName="origin_multiAngle")
    recode_progressNum(5)
    train(dataMethodName="origin_edge_sub")
    recode_progressNum(6)
    train(dataMethodName="origin_multiAngle_sub")
    recode_progressNum(7)
    train(dataMethodName="origin_multiAngle_edge")
    recode_progressNum(8)
    train(dataMethodName="origin_multiAngle_edge_sub")
