...
if __name__ == '__main__':
    ...
    exam_test(dataMethodName="origin")
    recode_progressNum(2)
    exam_test(dataMethodName="origin_sub")
    recode_progressNum(3)
    exam_test(dataMethodName="origin_edge")
    recode_progressNum(4)
    exam_test(dataMethodName="origin_multiAngle")
    recode_progressNum(5)
    exam_test(dataMethodName="origin_edge_sub")
    recode_progressNum(6)
    exam_test(dataMethodName="origin_multiAngle_sub")
    recode_progressNum(7)
    exam_test(dataMethodName="origin_multiAngle_edge")
    recode_progressNum(8)
    exam_test(dataMethodName="origin_multiAngle_edge_sub")
