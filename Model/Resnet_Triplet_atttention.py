...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, in_dim, is_CBAM,is_Triplet, dilation):
        self.inplanes = 64
...
def resnet(in_channel, layers=[3, 4, 6, 3], is_CBAM=None,is_Triplet=None, dilation=1):
