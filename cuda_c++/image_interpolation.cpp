...
/* Get an pixel from an image, if outside image, black or nearest pixel */
double getcolor_mindex3(int x, int y, int z, int sizx, int sizy, int sizz, float *I) {
...
double interpolate_3d_linear_black(double Tlocalx, double Tlocaly, double Tlocalz, int *Isize, float *Iin) {
    double Iout;
    /*  Linear interpolation variables */
...
double interpolate_3d_linear(double Tlocalx, double Tlocaly, double Tlocalz, int *Isize, float *Iin) {
    double Iout;
    /*  Linear interpolation variables */
    int xBas0, xBas1, yBas0, yBas1, zBas0, zBas1;
    double perc[8];
...
double interpolate_3d_cubic_black(double Tlocalx, double Tlocaly, double Tlocalz, int *Isize, float *Iin) {
    /* Floor of coordinate */
    double fTlocalx, fTlocaly, fTlocalz;
    /* Zero neighbor */
...
double interpolate_3d_cubic(double Tlocalx, double Tlocaly, double Tlocalz, int *Isize, float *Iin) {
    /* Floor of coordinate */
    double fTlocalx, fTlocaly, fTlocalz;
    /* Zero neighbor */
    int xBas0, yBas0, zBas0;
...
double interpolate_3d_double_gray(double Tlocalx, double Tlocaly, double Tlocalz, int *Isize, float *Iin, int cubic, int black){
    double Ipixel;
    if(cubic) {
